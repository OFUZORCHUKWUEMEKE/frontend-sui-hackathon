...
import { ChevronRight, MessageSquare, Shield, Zap, CheckCircle, Menu, Clock, Database, Bell } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
            ...
            <p className="text-slate-300">
              Deploy payment forms in seconds through natural conversation. No complex setup or technical knowledge required—just chat with our AI bot.
            </p>
          </div>
          ...
          <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
            ...
            <p className="text-slate-300">
              Gather customer information and process payments in one unified flow. Automated collection and verification eliminates manual tracking.
            </p>
          </div>
